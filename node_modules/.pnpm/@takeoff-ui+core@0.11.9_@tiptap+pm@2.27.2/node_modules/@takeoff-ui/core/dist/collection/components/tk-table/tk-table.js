...
export class TkTable {
    ...
    render() {
        ...
        return (h("div", { key: '7bef05efde71fe937cbf8d696be386a7e586c2d6', class: rootClasses, style: this.containerStyle, "data-testid": getDataTestId(this.dataTestid, 'container') }, this.renderHeader(), this.renderTable(), this.renderPagination()));
    }

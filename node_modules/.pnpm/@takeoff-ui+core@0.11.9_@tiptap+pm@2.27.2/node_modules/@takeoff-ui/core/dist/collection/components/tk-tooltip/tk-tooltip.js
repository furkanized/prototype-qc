...
export class TkTooltip {
    ...
    render() {
        ...
        return (h("div", { key: '10236d0ac062c5574174974cec6da65b70489d5d', class: "tk-tooltip", "data-testid": getDataTestId(this.dataTestid, 'container') }, h("slot", { key: '2069b22ceb94133347e13dfc54d9b32c00410787', name: "trigger" }), this.isOpen && (h("div", { key: 'cde814f061c1f107d1ca9d9e96d09ac417515281', ref: el => (this.tooltipElement = el), class: {
                'tk-tooltip-content': true,
                [`tk-tooltip-${this.variant}`]: !!this.variant,
            }, style: Object.assign({}, this.containerStyle), role: "tooltip", "data-testid": getDataTestId(this.dataTestid, 'content') }, this.hasContentSlot ? (h("slot", { name: "content" })) : (h(Fragment, null, _leftIcon, h("div", null, h("div", { class: "tk-tooltip-header", "data-testid": getDataTestId(this.dataTestid, 'header') }, this.header), h("div", { class: "tk-tooltip-description", "data-testid": getDataTestId(this.dataTestid, 'description') }, this.description)), _rightIcon)), h("div", { key: 'db79b0ab1c3d5f13c081cb62d1b5646725f74349', ref: el => (this.arrowElement = el), class: "tk-tooltip-arrow", "data-testid": getDataTestId(this.dataTestid, 'arrow') })))));
    }
    static get is() { return "tk-tooltip"; }
    ...
    static get properties() {
        return {
            "header": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Sets header text for the tooltip."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "description": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Sets description text for the tooltip."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "position": {
                ...
                "docs": {
                    ...
                    "text": "Sets the position of the tooltip."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "variant": {
                ...
                "docs": {
                    ...
                    "text": "Sets the color variant of the tooltip."
                },
                "getter": false,
                "setter": false,
                "reflect": false,

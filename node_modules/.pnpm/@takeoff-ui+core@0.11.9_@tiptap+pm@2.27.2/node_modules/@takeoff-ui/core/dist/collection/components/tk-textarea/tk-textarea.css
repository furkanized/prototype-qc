...
.tk-textarea-container .tk-textarea textarea {
  outline: none;
  border: none;
...
.tk-textarea-container .tk-textarea textarea::-webkit-scrollbar {
  width: 4px;
  height: 4px;
}
.tk-textarea-container .tk-textarea textarea::-webkit-scrollbar-track {
  background: var(--background-lightest);
  border-radius: 2px;
}
.tk-textarea-container .tk-textarea textarea::-webkit-scrollbar-thumb {
  border-radius: 3px;
  background: var(--secondary-sub-base);
}
.tk-textarea-container .tk-textarea textarea::-webkit-scrollbar-thumb:hover {
  background: var(--secondary-dark);
}
.tk-textarea-container .tk-textarea textarea::-webkit-scrollbar-corner {
  background: var(--background-lightest);
}
.tk-textarea-container .tk-textarea textarea::placeholder {
  color: var(--text-sub-base);
}
.tk-textarea-container .tk-textarea:hover:not(.tk-textarea-container[aria-disabled] .tk-textarea) {
  background-color: var(--background-lightest);
}
.tk-textarea-container .tk-textarea .counter {
  position: absolute;
  right: 28px;
  bottom: 6px;
  color: var(--text-base);
...
.tk-textarea-container .tk-textarea .counter.maxed {
  color: var(--states-danger-base);
}
.tk-textarea-container.large .label {

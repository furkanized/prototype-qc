...
export class TkPhoneInput {
    ...
    getFlagClass(country) {
        return classNames('flag', (country === null || country === void 0 ? void 0 : country.dialCode) ? `flag-${country === null || country === void 0 ? void 0 : country.id.toLowerCase()}` : 'flag-none');
    }
    renderLabel() {
        var _a;
        let label;
        if (((_a = this.label) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            const asterisk = h("span", { class: "tk-phone-input-asterisk" }, "*");
            label = (h("label", { htmlFor: this.uniqueId, class: "tk-phone-input-label" }, this.label, this.showAsterisk ? asterisk : ''));
        }
        return label;
    }
    /**
    ...
    renderCountrySelector() {
        return (h("div", { class: "tk-phone-input-dropdown" }, this.createDropdownButton(), this.isDropdownOpen && (h("div", { class: "tk-phone-input-dropdown-menu", role: "listbox", ref: el => (this.panelRef = el) }, this.createDropdownSearch(), this.createDropdownList()))));
    }
    /**
    ...
    createDropdownButton() {
        ...
        return (h("button", { class: "tk-phone-input-dropdown-button", onClick: this.toggleDropdown, type: "button" }, h("div", { class: selectedClass }, h("tk-icon", Object.assign({}, getIconElementProps('stat_minus_1', { variant: null, size: 'large' }, 'rounded', 'span'))), !this.hideFlag && this.renderFlag(this.selectedCountry), this.selectedCountry.dialCode && h("span", { class: "tk-phone-input-dial-code" }, this.selectedCountry.dialCode))));
    }
    /**
     * Create the search input for filtering countries in the dropdown.
     */
    createDropdownSearch() {
        return (h("tk-input", { class: "tk-phone-input-dropdown-menu-search", size: this.size, placeholder: "Search", value: this.searchTerm, "onTk-change": this.handleSearchChange, ref: el => (this.searchInput = el), icon: "search", iconPosition: "right", onClick: (e) => e.stopPropagation() }));
    }
    /**
     * Create the dropdown list of countries.
     */
    createDropdownList() {
        return (h("ul", { class: "tk-phone-input-menu" }, this.getFilteredCountries().map(country => (h("li", { class: "tk-phone-input-menu-item", onClick: () => this.handleCountrySelect(country), key: country.id, role: "option", "aria-selected": country.id === this.selectedCountry.id }, !this.hideFlag && this.renderFlag(country), country.label && h("span", { class: "tk-phone-input-menu-country-label" }, country.label), country.dialCode && h("span", { class: "tk-phone-input-menu-dial-id" }, country.dialCode))))));
    }
    /**
    ...
    renderFlag(country) {
        ...
        return country.dialCode ? (h("div", { class: flagClass, "aria-label": `${country.label} flag` })) : (h("div", { class: flagClass }, h("tk-icon", Object.assign({}, getIconElementProps('close', { color: 'var(--static-white)' })))));
    }
    /**
     * Render the component.
     */
    render() {
        return (h("div", { key: '7622740fa83a9e25aca50bed39634dfe9f12b578', class: classNames('tk-phone-input-container', `tk-phone-input-container-${this.size}`), "aria-invalid": this.invalid, "aria-disabled": this.disabled, "aria-readonly": this.readonly }, this.renderLabel(), h("div", { key: '86a1c6d319cea43d53824732efb1095244c247bb', class: "tk-phone-input-wrapper" }, this.renderCountrySelector(), this.renderPhoneInput()), renderHint(this.hint, this.error, this.invalid)));
    }
    static get is() { return "tk-phone-input"; }
    ...
    static get properties() {
        return {
            "value": {
                ...
                "mutable": true,
                "complexType": {
                    "original": "IPhoneInputValue | any",
                    "resolved": "any",
                    "references": {
                        "IPhoneInputValue": {
                            "location": "import",
                            "path": "./types",
                            "id": "src/components/tk-phone-input/types.ts::IPhoneInputValue",
                            "referenceLocation": "IPhoneInputValue"
                        }
                    }
                },
                "required": false,
            ...
            "label": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The label for the phone input."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
                ...
                "complexType": {
                    ...
                    "references": {
                        "ICountry": {
                            "location": "import",
                            "path": "./types",
                            "id": "src/components/tk-phone-input/types.ts::ICountry",
            ...
            "defaultCountry": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The default country to select (ISO country code)."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "placeholder": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Placeholder text for the phone input."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "hideFlag": {
                ...
                "docs": {
                    ...
                    "text": "Hides the phone flag icon in the dropdown button and list."
                },
                "getter": false,
                "setter": false,
                "reflect": false,

...
export class TkPopover {
    ...
    render() {
        return (h("div", { key: 'a8102448b35b6d36483f3fc894cf3e501e65f913', class: "tk-popover", "data-testid": getDataTestId(this.dataTestid, 'container') }, h("slot", { key: 'e990eab12540553215603e8a4048f4d4e6bd0a2f', name: "trigger" }), this.isOpen && (h("div", { key: '170c6b08b4a9abdc133513b1a55c514f6dc3f4fe', ref: el => (this.popoverElement = el),
            ...
            }, style: Object.assign({}, this.containerStyle), role: "popover", onClick: e => e.stopPropagation(), "data-testid": getDataTestId(this.dataTestid, 'content') }, this.hasContentSlot && h("slot", { key: '217923e970a0c1050fafd595a1977ea3d0789b43', name: "content" }), h("div", { key: '0ab91df3542c594b8185fa73f4fe4c4fb0ee778f', ref: el => (this.arrowElement = el), class: "tk-popover-arrow", "data-testid": getDataTestId(this.dataTestid, 'arrow') })))));
    }
    static get is() { return "tk-popover"; }
        ...
        return {
            "trigger": {
                ...
                "docs": {
                    ...
                    "text": "Sets the action of the popover."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "position": {
                ...
                "docs": {
                    ...
                    "text": "Sets the position of the popover."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "type": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "'white' | 'dark' | 'basic'",
                    "resolved": "\"basic\" | \"dark\" | \"white\"",
                    "references": {}
                },
                "required": false,
                "optional": false,
                "docs": {
                    ...
                    "text": "Sets the type of the popover."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Emitted when the open state of the popover changes"
                },
                "complexType": {
                    "original": "boolean",
                    "resolved": "boolean",

import { r as registerInstance, h, F as Fragment, d as getElement } from './index-D4ALLk7q.js';
...
const TkCard = class {
    ...
    createHeader() {
        ...
        if (this.hasHeaderSlot) {
            ...
            if (!this.header)
                return null;
            return (h("div", { "data-testid": getDataTestId(this.dataTestid, 'header-container'), class: classNames('tk-card-header', `tk-card-header-${this.headerPosition}`, {
                    [`tk-card-header-${this.headerType}`]: !this.imageOptions.background,
                }) }, h("div", { class: "tk-card-header-content", "data-testid": getDataTestId(this.dataTestid, 'header') }, this.hasAvatarSlot ? (h("slot", { name: "avatar" })) : (h(Fragment, null, this.showAvatar && (h("div", { class: "tk-card-avatar", "data-testid": getDataTestId(this.dataTestid, 'avatar-container') }, ' ', h("tk-avatar", Object.assign({}, this.avatarProps, { "data-testid": getDataTestId(this.dataTestid, 'avatar') })))))), h("div", { class: "tk-card-title-container", "data-testid": getDataTestId(this.dataTestid, 'title-container') }, this.subheader && (h("span", { class: "tk-card-subtitle", "data-testid": getDataTestId(this.dataTestid, 'subtitle') }, this.subheader)), this.header && (h("span", { class: "tk-card-title", "data-testid": getDataTestId(this.dataTestid, 'title') }, this.header)))), this.hasHeaderActionSlot ? (h("slot", { name: "header-action" })) : (this.showMenuButton && (h("tk-button", { variant: "neutral", icon: "more_vert", size: "base", type: "text", "aria-label": "TkCard Header Menu Button", dataTestid: getDataTestId(this.dataTestid, 'header-menu-button') })))));
        }
    }
    createImage() {
        ...
        return (h("div", { class: imageClasses, "data-testid": getDataTestId(this.dataTestid, 'image-container') }, h("img", { src: this.image, alt: "Card image", "data-testid": getDataTestId(this.dataTestid, 'image') })));
    }
    createContent() {
        if (this.hasContentSlot) {
            ...
            return (h("div", { class: "tk-card-content", style: this.contentStyle, "data-testid": getDataTestId(this.dataTestid, 'content') }, h("slot", null)));
        }
        return null;
    }
    createFooter() {
        if (this.hasFooterSlot) {
            ...
            return (h("div", { "data-testid": getDataTestId(this.dataTestid, 'footer'), class: classNames('tk-card-footer', {
    ...
    renderCardContent() {
        ...
        if (imageOption === 'top') {
            ...
            return (h(Fragment, null, imageOption === 'left' && image, h("div", { class: "tk-card-horizontal-has-image-container", "data-testid": getDataTestId(this.dataTestid, 'horizontal-has-image-container') }, header, content, footer), imageOption === 'right' && image));
        }
    }
    render() {
        ...
        return h("div", Object.assign({ key: '38196aa981f2f98e84e4d4ab726682f27a492112' }, rootProps), this.renderCardContent());
    }
    get el() { return getElement(this); }
};
TkCard.style = tkCardCss();

export { TkCard as tk_card };

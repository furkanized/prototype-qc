...
const TkPopover = class {
    ...
    render() {
        return (index.h("div", { key: 'a8102448b35b6d36483f3fc894cf3e501e65f913', class: "tk-popover", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'container') }, index.h("slot", { key: 'e990eab12540553215603e8a4048f4d4e6bd0a2f', name: "trigger" }), this.isOpen && (index.h("div", { key: '170c6b08b4a9abdc133513b1a55c514f6dc3f4fe', ref: el => (this.popoverElement = el),
            ...
            }, style: Object.assign({}, this.containerStyle), role: "popover", onClick: e => e.stopPropagation(), "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'content') }, this.hasContentSlot && index.h("slot", { key: '217923e970a0c1050fafd595a1977ea3d0789b43', name: "content" }), index.h("div", { key: '0ab91df3542c594b8185fa73f4fe4c4fb0ee778f', ref: el => (this.arrowElement = el), class: "tk-popover-arrow", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'arrow') })))));
    }

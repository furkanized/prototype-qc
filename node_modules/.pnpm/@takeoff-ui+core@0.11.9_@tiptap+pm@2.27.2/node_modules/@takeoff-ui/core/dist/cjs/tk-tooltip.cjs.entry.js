...
const TkTooltip = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '10236d0ac062c5574174974cec6da65b70489d5d', class: "tk-tooltip", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'container') }, index.h("slot", { key: '2069b22ceb94133347e13dfc54d9b32c00410787', name: "trigger" }), this.isOpen && (index.h("div", { key: 'cde814f061c1f107d1ca9d9e96d09ac417515281', ref: el => (this.tooltipElement = el), class: {
                'tk-tooltip-content': true,
                [`tk-tooltip-${this.variant}`]: !!this.variant,
            }, style: Object.assign({}, this.containerStyle), role: "tooltip", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'content') }, this.hasContentSlot ? (index.h("slot", { name: "content" })) : (index.h(index.Fragment, null, _leftIcon, index.h("div", null, index.h("div", { class: "tk-tooltip-header", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'header') }, this.header), index.h("div", { class: "tk-tooltip-description", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'description') }, this.description)), _rightIcon)), index.h("div", { key: 'db79b0ab1c3d5f13c081cb62d1b5646725f74349', ref: el => (this.arrowElement = el), class: "tk-tooltip-arrow", "data-testid": testIdUtils.getDataTestId(this.dataTestid, 'arrow') })))));
    }

...
const TkPhoneInput = class {
     ...
     */
    render() {
        return (index.h("div", { key: '7622740fa83a9e25aca50bed39634dfe9f12b578', class: index$1.classNames('tk-phone-input-container', `tk-phone-input-container-${this.size}`), "aria-invalid": this.invalid, "aria-disabled": this.disabled, "aria-readonly": this.readonly }, this.renderLabel(), index.h("div", { key: '86a1c6d319cea43d53824732efb1095244c247bb', class: "tk-phone-input-wrapper" }, this.renderCountrySelector(), this.renderPhoneInput()), hintUtils.renderHint(this.hint, this.error, this.invalid)));
    }

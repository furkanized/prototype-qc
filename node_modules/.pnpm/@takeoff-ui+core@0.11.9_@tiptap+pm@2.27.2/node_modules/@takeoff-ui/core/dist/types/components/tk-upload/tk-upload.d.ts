 ...
 */
export declare class TkUpload implements ComponentInterface {
    private inputRef;
    el: HTMLTkUploadElement;
     ...
     */
    value: File[];
    valueChanged(newValue: File[]): void;
    /**
     ...
     */
    tkUpload: EventEmitter<File[]>;
    /**
     * Emitted when a file is removed from the accepted list.
     */
    tkRemovedFile: EventEmitter<File>;
    /**
     * Emitted when a file is download button is clicked.
     */
    tkDownloadFile: EventEmitter<File>;
    private isImageFile;
    private handleDragEnter;
    private handleDragLeave;
    private handleDragOver;
    private handleDrop;
    private handleProcessFiles;

 ...
 */
export declare class TkTextarea implements ComponentInterface {
    private nativeInput?;
    private tabindex?;
    private uniqueId;
    el: HTMLTkTextareaElement;
     ...
     */
    tkInput: EventEmitter<KeyboardEvent>;
    /**
     * Emitted when the value has changed.
     */
    tkChange: EventEmitter<string | number | undefined | null>;
    /**

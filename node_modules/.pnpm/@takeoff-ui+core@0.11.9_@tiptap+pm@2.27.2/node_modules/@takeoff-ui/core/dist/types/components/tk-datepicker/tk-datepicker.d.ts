 ...
 */
export declare class TkDatePicker {
    private today;
    ...
    private uniqueId;
    private cleanup;
    private isUpdatingAmPm;
    private weeksLength;
    private clickOutsideMixin?;
    el: HTMLTkDatepickerElement;
    ...
    internalAmPm: 'AM' | 'PM';
    internalAmPmChanged(newValue: 'AM' | 'PM'): void;
    hoverDate: Date | null;
    currentView: 'days' | 'months' | 'years';
    maskOptions?: IInputMaskOptions;
    isInvalid: boolean;
    isOpen: boolean;
    concealUntilMeasured: boolean;
     ...
     */
    timeFormat: '12' | '24';
    timeOnlyChanged(): void;
    timeFormatChanged(): void;
    /**
     ...
     */
    tkInputChange: EventEmitter<string>;
    /**
     * Emitted on date selection changes
     */
    tkChange: EventEmitter<IDateSelection | string | null>;
    /**
     * Emitted when the input is invalid
     */
    tkInvalid: EventEmitter<{
        message: string;
        value: string;
    }>;
    ...
    private updateTimeBasedOnAmPm;
    private getResolvedFirstDayIndex;
    private getFullDateTimeFormat;
    private getOnlyTimeFormat;
    private getDefaultTime;
    private getDateWithTime;
    private getMaskOptionsFromDateFormat;
    private processDateValue;
    private initializeDates;
    private measureCalendarTableHeight;
    private remeasureCalendarOnNextFrame;
    private normalizeDate;
    private formatDate;
    private formatFullDateTime;
    private formatDateOrDateTime;
    private parseInputDate;
    private parseFullDateTime;
    private parseTimeString;
    private isDateDisabled;
    private isMonthFullyDisabled;
    private parseDefaultDate;
    private getFirstAvailableAllowedMonth;
    private formatInputValue;
    private isToday;
    private ensureDateTimeInitialized;
    private ensureRangeOrder;

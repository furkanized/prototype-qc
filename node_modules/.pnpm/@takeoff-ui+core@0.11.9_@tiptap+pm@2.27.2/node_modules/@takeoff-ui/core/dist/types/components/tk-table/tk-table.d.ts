...
import { ITableColumn, ITableFilter, ITableCellEdit, ITableRequest, ITableExportOptions, ITableSort, ITableGroup } from './types';
 ...
 */
export declare class TkTable implements ComponentInterface {
    private refSelectAll;
    private elFilterPanelElement;
    private isResizing;
    private resizeColumnIndex;
    private startX;
    private startWidth;
    private customCellCache;
    private isSelectionUpdating;
    private cleanup;
    el: HTMLTkTableElement;
    elActiveSearchIcon: HTMLElement;
    selectColumn: ITableColumn;
    sortField: string;
    sortOrder: 'asc' | 'desc';
    filters: ITableFilter[];
    currentPage: number;
    renderData: Record<PropertyKey, unknown>[];
    hasHeaderRightSlot: boolean;
    hasEmptyDataSlot: boolean;
    hasEmptyFilterSlot: boolean;
    ...
    sorts: ITableSort[];
    groupedData: ITableGroup[];
    groupByColumnField: string;
    isControlledGrouping: boolean;
    expandedGroups: any[];
     ...
     */
    rowsPerPage: number;
    rowsPerPageChanged(newValue: number, oldValue: number): void;
    /**
     ...
     */
    groupBy: string;
    groupByChanged(newValue: string, oldValue: string): void;
    /**
     ...
     *
     */
    tkSelectionChange: EventEmitter<any[] | any>;
    /**
     * Emitted when a request needs to be made to the server.
     */
    tkRequest: EventEmitter<ITableRequest>;
    /**
     * Emitted when the expanded rows change.
     */
    tkExpandedRowsChange: EventEmitter<any[]>;
    /**
     * Emitted when a cell is edited.
     */
    tkCellEdit: EventEmitter<ITableCellEdit>;
    /**
     * Emitted when a row is clicked.
     * @param row The row data that was clicked
     */
    tkRowClick: EventEmitter<any>;
    /**
     ...
     */
    tkGroupByChange: EventEmitter<string | null>;
     ...
     */
    private getTableViewData;
    private toggleExpandRow;
    private toggleExpandGroup;
    private closeFilterPanel;
    private isAllRowsSelected;
    private setDataTestidAttribute;
    private handleSearchIconClick;
    private handleInputFilterApply;
    private handleSearchButtonClick;
    private handleSearchCancelButtonClick;
    private handleInputBlur;
    private handleSelectAll;
    private handleCheckboxSelectChange;
    private handleRadioSelectChange;
    private handlePageChange;
    private handleSortIconClick;
    private handleSingleSort;
    private handleMultiSort;
    private applySorting;
    private createFilterPanel;
    private handleCheckboxFilterApply;
    private handleRadioFilterApply;
    private handleDatepickerFilterApply;
    private handleTreeviewFilterApply;
    ...
    private getStickyColumnClasses;
    private getStickyColumnStyle;
    private getSelectionStickyStyle;
    private createHead;
    private createBody;

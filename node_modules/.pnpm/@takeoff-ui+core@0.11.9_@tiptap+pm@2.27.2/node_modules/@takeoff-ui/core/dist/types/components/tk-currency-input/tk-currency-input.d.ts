...
import type { Separator, ICurrency } from './types';
/**
 ...
 */
export declare class TkCurrencyInput implements ComponentInterface {
    private el;
    /**

 ...
 */
export declare class TkSelect implements ComponentInterface {
    private hasEmptyDataSlot;
    ...
    private boundRunFilterForMultiple;
    private cleanup;
    private isItemClickFlag;
    private clickOutsideMixin?;
    private flatOptions;
    el: HTMLTkSelectElement;
     ...
     */
    options: any[];
    protected optionsChanged(newValue: any[], oldValue: any[]): void;
    /**
     ...
     */
    tkSelectAll: EventEmitter<boolean>;
    /**
     * Emitted when the select is opened
     */
    tkOpen: EventEmitter<void>;
    /**
     * Emitted when the select is closed
     */
    tkClose: EventEmitter<void>;
    ...
    private isGrouped;
    private setFlatOptions;
    private runFilterForMultiple;
    private defaultFilter;
    private isOptionSelected;
    private isAllSelected;
    private getOptionLabel;
    private getOptionValue;
    private getDisplayValueForMultiple;
    private setRenderOptions;
    private getSelectedItem;
    private setValue;
    private scrollItem;
    private getNextEnabledItemIndex;

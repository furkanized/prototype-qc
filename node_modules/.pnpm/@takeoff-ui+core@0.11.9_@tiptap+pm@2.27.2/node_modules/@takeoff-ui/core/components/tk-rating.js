import { h as t, p as e, H as i, c as r, t as s } from './p-BfLQgzDX.js';
import { c as a } from './p-D7YaJBkB.js';
import { g as n } from './p-BDMnqEGL.js';
const o = (e = 'star', i = 'default') => {
    switch (e) {
      case 'star':
        if ('fill' == i)
          return t(
      ...
      case 'dot':
        if ('fill' == i)
          return t(
            ...
            t('circle', { cx: '10', cy: '10', r: '10', fill: '#22C55E' }),
          );
        if ('semi' == i)
          return t(
            'svg',
        ...
        if ('default' == i)
          return t(
            'svg',
            { xmlns: 'http://www.w3.org/2000/svg', width: '20', height: '20', viewBox: '0 0 20 20', fill: 'none' },
            t('circle', { 'cx': '10', 'cy': '10', 'r': '9', 'stroke': '#CAF1D8', 'stroke-width': '2' }),
          );
        if ('disabled' == i)
          return t(
            'svg',
            { xmlns: 'http://www.w3.org/2000/svg', width: '20', height: '20', viewBox: '0 0 20 20', fill: 'none' },
            t('circle', { 'cx': '10', 'cy': '10', 'r': '9', 'stroke': '#E1E4EA', 'stroke-width': '2' }),
          );
    }
  },
  l = e(
    class extends i {
      constructor(t) {
        (super(),
          ...
          (this.type = 'star'),
          (this.value = 0),
          (this.showRatingValue = !1),
          (this.disabled = !1),
          (this.readonly = !1));
      }
      handleRatingClick(t) {
        this.disabled || this.readonly || this.tkChange.emit(t);
      }
      handleMouseMove(t) {
        this.disabled || this.readonly || (t !== this.hoverRating && (this.hoverRating = t));
      }
      handleMouseLeave() {
        this.disabled || this.readonly || (this.hoverRating = 0);
      }
      renderIcon(e) {
        const i = this.hoverRating || this.value;
        let r = 'default';
        return (
          e <= i ? (r = 'fill') : e - 0.5 === i && (r = 'semi'),
          this.disabled
            ? t(
                'div',
                { 'class': a('tk-rating', this.type, r, { disabled: this.disabled }), 'data-testid': n(this.dataTestid, 'item', '' + e) },
                o(this.type, 'disabled'),
                this.showRatingValue && '0' + e,
              )
            : t(
                'div',
                {
                  'class': a('tk-rating', this.type, r, this.readonly, { disabled: this.disabled }),
                  'onMouseMove': () => this.handleMouseMove(e),
                  'onMouseLeave': () => this.handleMouseLeave(),
                  'onClick': () => this.handleRatingClick(e),
                  'data-testid': n(this.dataTestid, 'item', '' + e),
                },
                o(this.type, r),
                ' ',
                this.showRatingValue && '0' + e,
      ...
      renderNumberRating() {
        return [1, 2, 3, 4, 5].map(e =>
          t(
            'div',
            {
              'class': a('tk-rating', 'number', 'rating-number-' + e, { readonly: this.readonly, disabled: this.disabled, selected: e === this.value }),
              'onMouseMove': () => this.handleMouseMove(e),
              'onMouseLeave': () => this.handleMouseLeave(),
              'onClick': () => this.handleRatingClick(e),
              'data-testid': n(this.dataTestid, 'item', '' + e),
      ...
      render() {
        const e = 'number' === this.type;
        return t(
          'div',
          { 'key': '8ebe4c78e2663354644331d88c278e4c54ba09ad', 'class': a('tk-rating-container', { number: e }), 'data-testid': n(this.dataTestid, 'container') },
          e ? this.renderNumberRating() : Array.from({ length: this.maxRating }, (t, e) => this.renderIcon(e + 1)),
        );
      }
      static get style() {
  ...
  h = function () {
    'undefined' != typeof customElements &&
      ['tk-rating'].forEach(t => {
        'tk-rating' === t && (customElements.get(s(t)) || customElements.define(s(t), l));
      });
  };
export { d as TkRating, h as defineCustomElement };

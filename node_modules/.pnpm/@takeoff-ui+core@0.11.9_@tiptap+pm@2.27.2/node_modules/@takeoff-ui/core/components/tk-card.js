import { p as t, H as a, h as r, F as e, t as o } from './p-BfLQgzDX.js';
import { c as i } from './p-D7YaJBkB.js';
import { g as d } from './p-BDMnqEGL.js';
import { d as s } from './p-BVlaGNiB.js';
import { d as n } from './p-BY6PxsS2.js';
import { d as c } from './p-BpML1w-i.js';
import { d as l } from './p-C6qt54JA.js';
const h = t(
    class extends a {
      constructor(t) {
        (super(),
          ...
          this.__attachShadow(),
          (this.imageOptions = { position: 'top', background: !1, windowed: !0 }),
          (this.showAvatar = !1),
          (this.avatarProps = { severity: 'light', background: 'solid', rounded: !0, size: 'small' }),
          (this.hideHeader = !1),
          (this.showMenuButton = !1),
          (this.image = null),
          (this.headerPosition = 'top'),
          (this.headerType = 'basic'),
          (this.horizontal = !1),
          (this.footerType = 'basic'),
          (this.enableHoverShadow = !1),
      ...
      componentWillLoad() {
        ((this.hasHeaderSlot = !!this.el.querySelector(':scope > [slot="header"]')),
          ...
          (this.hasDefaultSlotBody = Array.from(this.el.childNodes).some(t => t.nodeType === Node.ELEMENT_NODE && !t.hasAttribute('slot'))));
      }
      createHeader() {
          ...
          : this.hasHeaderSlot
            ...
            : this.header
              ? r(
                  'div',
                  {
                    'data-testid': d(this.dataTestid, 'header-container'),
                    'class': i('tk-card-header', 'tk-card-header-' + this.headerPosition, { ['tk-card-header-' + this.headerType]: !this.imageOptions.background }),
                  },
                  r(
                    'div',
                    { 'class': 'tk-card-header-content', 'data-testid': d(this.dataTestid, 'header') },
                    this.hasAvatarSlot
                      ? r('slot', { name: 'avatar' })
                      : r(
                          e,
                          ...
                          this.showAvatar &&
                            r(
                              'div',
                              { 'class': 'tk-card-avatar', 'data-testid': d(this.dataTestid, 'avatar-container') },
                              ' ',
                              r('tk-avatar', Object.assign({}, this.avatarProps, { 'data-testid': d(this.dataTestid, 'avatar') })),
                            ),
                        ),
                    r(
                      'div',
                      { 'class': 'tk-card-title-container', 'data-testid': d(this.dataTestid, 'title-container') },
                      this.subheader && r('span', { 'class': 'tk-card-subtitle', 'data-testid': d(this.dataTestid, 'subtitle') }, this.subheader),
                      this.header && r('span', { 'class': 'tk-card-title', 'data-testid': d(this.dataTestid, 'title') }, this.header),
                    ),
                  ),
                  this.hasHeaderActionSlot
                    ? r('slot', { name: 'header-action' })
                    : this.showMenuButton &&
                        r('tk-button', {
                          'variant': 'neutral',
                          'icon': 'more_vert',
                          ...
                          'dataTestid': d(this.dataTestid, 'header-menu-button'),
                        }),
                )
              : null;
      }
      createImage() {
        ...
        const t = i('tk-card-image', 'tk-card-image-' + this.imageOptions.position, { 'tk-card-windowed-image': this.imageOptions.windowed });
        return r(
          'div',
          { 'class': t, 'data-testid': d(this.dataTestid, 'image-container') },
          r('img', { 'src': this.image, 'alt': 'Card image', 'data-testid': d(this.dataTestid, 'image') }),
        );
      }
      createContent() {
        return this.hasContentSlot
          ? r('slot', { name: 'content' })
          : this.hasDefaultSlotBody
            ? r('div', { 'class': 'tk-card-content', 'style': this.contentStyle, 'data-testid': d(this.dataTestid, 'content') }, r('slot', null))
            : null;
      }
      createFooter() {
        return this.hasFooterSlot
          ...
          : this.hasFooterActionsSlot
            ? r(
                'div',
                { 'data-testid': d(this.dataTestid, 'footer'), 'class': i('tk-card-footer', { ['tk-card-footer-' + this.footerType]: !this.imageOptions.background }) },
                r('slot', { name: 'footer-actions' }),
              )
            : null;
      }
      renderCardContent() {
        const t = this.createHeader(),
          a = this.createImage(),
          o = this.createContent(),
          i = this.createFooter(),
          s = this.imageOptions.position;
        return 'top' === s
          ? r(e, null, 'top' === this.headerPosition && t, a, 'bottom' === this.headerPosition && t, o, i)
          : !this.horizontal || ('left' !== s && 'right' !== s)
            ? void 0
            : r(
                e,
                null,
                'left' === s && a,
                r('div', { 'class': 'tk-card-horizontal-has-image-container', 'data-testid': d(this.dataTestid, 'horizontal-has-image-container') }, t, o, i),
                'right' === s && a,
              );
      }
      render() {
        const t = {
          ...
          'data-testid': d(this.dataTestid, 'container'),
        };
        return r('div', Object.assign({ key: '38196aa981f2f98e84e4d4ab726682f27a492112' }, t), this.renderCardContent());
      }
      get el() {
        return this;
      }
  ...
  m = function () {
    'undefined' != typeof customElements &&
      ['tk-card', 'tk-avatar', 'tk-button', 'tk-icon', 'tk-spinner'].forEach(t => {
        switch (t) {
          case 'tk-card':
            customElements.get(o(t)) || customElements.define(o(t), h);
            break;
          case 'tk-avatar':
            customElements.get(o(t)) || s();
            break;
          case 'tk-button':
...
export { k as TkCard, m as defineCustomElement };
